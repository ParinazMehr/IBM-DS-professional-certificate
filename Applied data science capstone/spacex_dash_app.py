...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        class_0 = data[data['class']==0].shape[0]
        class_1 = data[data['class']==1].shape[0]
        class_values = [class_0/data.shape[0]*100, class_1/data.shape[0]*100]
        names = ['0', '1']
        fig = px.pie(data, values=class_values, names=names, title='Total success launches for site '+entered_site)
        return fig
